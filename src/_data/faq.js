module.exports = {
	portraitPhotoWalks: [
		{
			hu: {
				id: "segitesz-pozolni",
				question: "Nem vagyok valami fotogén, segítesz majd pózolni a fotózáskor?",
				answer: "A legtöbben nem vagyunk szakképzett modellek, akik tudják, hogy hogyan nézzenek ki a legjobban a fotókon. A legtöbb ember a galériámban pontosan ugyanígy érezte magát a fotózás előtt. Természetesen, segítek a pózokban, de ez nem jelenti azt, hogy a képeid pózoltnak fognak kinézni a végén. Inkább pillanatokat igyekszem megörökíteni, amihez természetes, laza, időnként vicces dolgokat kérek Tőled. Ezekből az érzésekből lesznek a legtermészetesebb fotók, amiket a legjobban fogsz szeretni!",
			},
			en: {
				id: "help-with-posing",
				question: "I'm not very photogenic, can you help me with posing?",
				answer: "Most of us aren't models who know how they'll look their best in photos. That's exactly how most people in my galleries felt before the photoshoot. Certainly, I'll help you with posing, but that doesn't mean your photos will look posed in the end. I prefer to capture candid moments, for which I'll give you some laid-back, fun, and sometimes silly prompts. These will be the photos with the purest emotions, which you'll love the most!",
			},
		},
		{
			hu: {
				id: "fotos-stilus",
				question: "Hogyan írnád le a fotós stílusodat?",
				answer: "A stílusomat úgy fogalmaznám meg, hogy őszinte és hiteles, portréfotózások esetén óvatos javaslatokkal és iránymutatásokkal kiegészítve. Jobban szeretek dokumentálni, mint irányítani, mert tudom, hogy a beállítatlan képek a legőszintébbek. Ez azt jelenti, hogy megbeszélünk egy koncepciót, és hagylak Téged/Titeket létezni egy kicsit, miközben én kattintgatok minden irányból. A szerkesztési stílusom a napszak és évszak függvényében változik, de összességében szeretek meleg, aranyló tónusokat használni szerkesztéskor, és sosem tolom túl a szerkesztéseket.",
			},
			en: {
				id: "photography-style",
				question: "How would you describe your photography style?",
				answer: "My photography style is authentic and candid, with a bit of careful guidance and suggestions for portrait shoots. I'm more of the documenter/photojournalist type than the poser/director type. This means I prefer talking about a concept with you and just letting you be yourself, while I'm busy taking shots from all angles, capturing your most authentic moments. My editing style depends a lot on the time of day and time of year, but I love using warm, golden tones in my images, and I never over-edit my photos.",
			},
		},
		{
			hu: {
				...
				answer: "Arra megyünk, amerre szeretnél, Budapesten, vagy a környéken. Ha szeretnél, válassz olyan helyszínt, amely közel áll a szívedhez. Ha nincs ötleted helyszínre, tudom ajánlani a pörgős belvárost a rengeteg nagyszerű fotós lehetőség miatt, de nagyon szívesen fotózom erdőben, mezőn, vagy természetvédelmi területen, ha természetközeli képeket szeretnél.",
			},
			en: {
				id: "where-do-we-walk",
				question: "Where do we walk?",
				answer: "We can walk and shoot wherever you want in and around Budapest. You may choose any location that is close to your heart. If you don't have a specific idea, I can recommend the inner districts for their photographic possibilities, but I don't shy away from going to a nearby nature reserve or forest to take more close-to-nature photos.",
			},
		},
		{
			hu: {
		...
		},
		{
			hu: {
				id: "hogyan-kapom-meg",
				question: "Hogyan kapom meg a végleges képeket?",
				answer: "Az elkészült képeket digitálisan, egy Google Drive vagy Dropbox mappában, publikus linkként fogod megkapni. Ez azt jelenti, hogy csak a link birtokában lévő emberek látják a mappa tartalmát (vagyis Te és én), így nem szükséges az email címedet megadnod a fotóid eléréséhez. Innen le tudod tölteni az összes képet a legnagyobb felbontásban, eredeti minőségben, amiket utána ki is tudsz nyomtatni tetszésed szerinti méretben.",
			},
			en: {
				id: "how-do-i-receive-photos",
		...
		},
		{
			...
			en: {
				...
				answer: "My camera has 2 identical memory cards in it, so every time I take a photo, it is written to both memory cards simultaneously. This way, in the unlikely event that one memory card fails, the other card will still have every single photo I took of you. At home, I copy the raw photos from my portrait shoots to two different hard drives, and I keep the backup files until I've sent you your final images.",
			},
		},
		{
			hu: {
		...
		},
		{
			hu: {
				id: "nyers-kepek",
				question: "Megkapom a nyers képeket is?",
				answer: "Számomra nagyon fontos az, hogy a fotózás után 100%-ban elkészült, színkezelt képeket kapj tőlem. Akár online szeretnéd felhasználni a képeket, akár egy nyomdába szeretnéd elküldeni őket nyomtatásra, a képeid azonnal használatra készek lesznek, amikor megkapod őket. Ezért nem küldöm el a nyers fájlokat.",
			},
			en: {
				id: "raw-files",
				question: "Will I get the raw photos, too?",
				answer: "It's very important for me that you only get 100% done, color-corrected images after your photoshoot. Whether you want to share them with your friends right away or send them to a lab for printing, your photos will be ready-for-use when you receive them. Therefore, I don't send out the unedited raw files.",
			},
		},
		{
			hu: {
		...
		},
		{
			...
			en: {
				...
				answer: "Usually I'm very flexible in terms of free time, so we can, in many cases, shoot on the day you write to me, or the day after. If you have an urgent photoshoot request, definitely contact me, so we can talk about when I can go walk-and-shoot with you. There's no extra charge for urgent photoshoots, if I can manage the shoot.",
			},
		},
		{
			hu: {
		...
		{
			hu: {
				id: "elvesztettem-a-kepeket",
				question: "Elvesztettem a Tőled kapott képeimet. Mit tegyek?",
				answer: "Semmi gond, írj rám bátran, minden elküldött képed le van mentve a merevlemezemen és megvannak a felhőben is. Ezeket mindenféle díjtól mentesen, bármikor a rendelkezésedre tudom bocsájtani. Írj egy üzenetet, és már küldöm is!",
			},
			en: {
				id: "lost-my-photos",
	...
	analogPhotoWalks: [
		...
		},
		{
			hu: {
				id: "film-valasztas",
				question: "Segítesz a megfelelő filmtekercs kiválasztásában?",
				answer: "Persze, szívesen! Tudom, hogy a filmtekercsek világában való eligazodás néha kihívást jelenthet, különösen a bizonyos opciók hiányosságainak fényében. Ha a kívánt filmtekercs már nem kapható vagy ideiglenesen nincs raktáron, akkor igyekszünk találni egy olyan alternatívát, amely közel áll az elképzelésedhez.",
			},
			en: {
				id: "choosing-film",
				question: "Can you provide guidance in choosing the right film stocks?",
				answer: "Absolutely! We understand that navigating the world of film stocks can be overwhelming, especially with the scarcity of certain options. If your preferred film stock has been discontinued or is temporarily out of stock, we will work closely with you to find an alternative that closely aligns with your vision.",
			},
		},
		{
			hu: {
				id: "mennyi-ido",
				question: "Mennyi idő múlva kapom meg a végleges képeket?",
				answer: "A végleges fotók és a nyomtatott képek kézhezvétele az általunk választott labor elfoglaltságának függvényében változik. A labor előhívási és szkennelési ideje változó, de általában egy hét alatt meg szokott történni. Ez az idő azonban a labor elfoglaltságától és a választott film típusától függően változhat.",
			},
			en: {
				id: "how-long",
				question: "How long does it take to receive the final images?",
				answer: "The turnaround time for receiving your final prints depends on the lab we choose for developing the film stock. The lab's processing time may vary, but rest assured that we prioritize quality and timely delivery.",
			},
		},
		{
			hu: {
				id: "digitalis-kombinacio",
				question: "Tudjuk-e kombinálni a film- és digitális fényképezést a fotózásom során?",
				answer: "Természetesen! Megértem, hogy mind a filmes, mind a digitális fényképezésnek megvannak a maga előnyei. Ha a két médium keverését szeretnéd, abszolút megoldható! A digitális képek esetén az általános árak vonatkoznak rájuk.",
			},
			en: {
				id: "combine-digital",
				question: "Can I combine film and digital photography for my session?",
				answer: "Certainly! I understand that both film and digital photography have their unique advantages. If you prefer a blend of the two mediums, I can absolutely accommodate that request. We will discuss your vision and work together to create a seamless fusion of film and digital elements. For the digital images, my regular pricing applies.",
			},
		},
		{
			hu: {
				id: "felszereles",
				question: "Milyen fényképezőgéppel és objektívekkel fotózol filmre?",
				answer: "A filmfotózás során a megbízható, öreg Szovjet Zenit E analóg tükörreflexes kamerámat használom, különböző M42-es foglalatú objektívekkel. Sok 50 mm körüli objektívem van, de rendelkezem egy kiemelkedő élességgel rendelkező 135 mm-es üveggel is. Legtöbbször a mesebeli Helios 44-2-t használom, amely különleges, csavart bokeh hatást hoz létre. Ha többet szeretnél megtudni a rendelkezésre álló objektívekről, írj bátran üzenetet.",
			},
			en: {
				id: "gear",
				question: "What camera and lenses do you use for film portraits?",
				answer: "I use my trust old soviet-made Zenit E analog SLR camera for film photography with a variety of M42 mount lenses. I offer a wide variety of ~50mm lenses, but I sport a 135mm one with excellent sharpness. My favorite lens is the mightly Helios 44-2 with its swirly bokeh rendering. Definitely write me a message if you want to learn more about the lenses I have.",
			},
		},
	]
}
