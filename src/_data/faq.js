	...
	items: [
		...
		},
		{
			...
			en: {
				...
				answer: "Usually I'll send you the finished photos in 1-3 working days, after you sent me the ones you've selected for editing. Depending on how busy I am with shooting and editing at the given time, this interval might change, but I'll let you know about this in advance.",
			},
		},
		{
			hu: {
		...
		},
		{
			hu: {
				...
				answer: "Minden általad kiválasztott fotót színkezelni fogok oly módon, hogy az tükrözze a személyiségedet, a helyszínt, és a fotózásunk témáját. A retusálásba beletartozik a bőr tökéletlenségek eltávolítása, illetve az esetleges babahajak eltávolítása a képekről.",
			},
			en: {
				question: "Do you edit the photos?",
				answer: "All photos you select after the shoot will be color-graded in a way that matches your personality, the location, and the theme of the shoot. Retouching includes removing skin imperfections and unnecessary flying hairs.",
			},
		},
		{
			hu: {
				question: "Megkapom a nyers képeket is?",
				answer: "Nem adok ki nyers képeket, csak olyanokat, amelyek tükrözik a szerkesztési stílusomat. Ez azért van, hogy az emberek ne kapjanak pontatlan képet a munkám minőségéről.",
			},
			en: {
				question: "Will I get the raw photos, too?",
				answer: "I don't hand out unedited photos, only processed ones that reflect my personal editing style. This is to prevent people getting an inaccurate representation of the quality of my work.",
			},
		},
		{
			hu: {
				question: "Miért fekete-fehérek és vízjelezettek a válogatásra kiadott képek?",
				answer: "Azért fekete-fehérek, hogy jobban tudj koncentrálni a képen az arckifejezésedre, a pózra, a környezetre; nem akarom, hogy a nyers színek, amelyeken később úgyis alakítani fogok, elvegyék a kedved egy fotótól. A válogatásra kiadott képek továbbá vízjellel vannak ellátva, hogy jelöljék, hogy ezek nem véglegesen elkészített képek.",
			},
			en: {
