module.exports = {
	items: [
		...
		},
		{
			...
			hu: {
				name: "V. Jázmin",
				text: "Eddig kétszer volt alkalmam együtt dolgozni Rolanddal, és mindkét alkalom felejthetetlen élmény volt. Az első alkalommal nem tudtam mire számítsak, azt meg főleg nem, hogy hogyan kell \"pózolni\" a kamera előtt. Viszont Roland a humorával az első pillanattól kezdve elfelejtette, hogy egyáltalán fotózáson vagyok! Amikor a párommal mentünk hozzá, féltünk, hogy furcsa lesz kamera előtt csókot váltani, de ott is végig humorizált, kihozta belőlünk a természetes, meghitt pillanatainkat. Ezáltal a fotók nem beállított pillanatokat, hanem valódi szeretetet sugároznak, amikre mindig mosolyogva nézünk. Röviden, ha valakit, Rolandot csakis ajánlani tudom!",
